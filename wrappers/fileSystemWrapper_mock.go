...
func (_m *MockFileSystemWrapper) CreateDirectory(path string) error {
	ret := _m.Called(path)
...
func (_m *MockFileSystemWrapper) Destroy(path string) error {
	ret := _m.Called(path)
...
func (_m *MockFileSystemWrapper) WriteFile(path string, data string) error {
